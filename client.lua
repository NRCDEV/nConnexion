...
local connectMenu = RageUI.CreateMenu("Bienvenue", "NT DEV")
            ...
            RageUI.IsVisible(connectMenu, function()
                ...
                if connect then
                    ...
                    if chargement >= 1.0 then
                        ...
                        ESX.ShowAdvancedNotification("Bienvenue", "~g~Information", "Bienvenue sur ~b~UltimateV", 'CHAR_MP_FM_CONTACT', 1)
                        DisplayRadar(true)
                    end
                end
            end)
